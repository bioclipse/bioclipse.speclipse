 ...
 * image files:
 * 
 * JFileChooser chooser = new JFileChooser(); SpokFileFilter filter = new
 * SpokFileFilter( new String{"gif", "jpg"}, "JPEG & GIF Images")
 * chooser.addChoosableFileFilter(filter); chooser.showOpenDialog(this);
 * 
 * @version 1.9 04/23/99
 * @author Jeff Dinkins
 */
public class SpokFileFilter extends FileFilter {

	private Hashtable<String,SpokFileFilter> filters = null;
	...
	public final static String[] jdx = { "jdx", "dx" };

	public final static String txt = "txt";

	public final static String[] cml = { "cml", "xml" };
	
	public final static String[] mzdata = { "mzdata", "mzData", "mz" };

	public final static String xml = "xml";

	public static void addChoosableFileFilters(JFileChooser chooser) {
		SpokFileFilter txtFilter = new SpokFileFilter(SpokFileFilter.txt,
				"Golm-DataSet");
		chooser.addChoosableFileFilter(txtFilter);

		SpokFileFilter jdxFilter = new SpokFileFilter(SpokFileFilter.jdx,
				"JCamp-DX Files");
		chooser.addChoosableFileFilter(jdxFilter);

		SpokFileFilter cmlFilter = new SpokFileFilter(SpokFileFilter.cml,
				"Chemical Markup Language Files");
	 ...
	 * @see #addExtension
	 */
	public SpokFileFilter() {
		this.filters = new Hashtable<String,SpokFileFilter>();
	}

	/**
	 * Creates a file filter that accepts files with the given extension.
	 * Example: new SpokFileFilter("jpg");
	 * 
	 * @see #addExtension
	 */
	public SpokFileFilter(String extension) {
		this(extension, null);
	}

	/**
	 * Creates a file filter that accepts the given file type. Example: new
	 * SpokFileFilter("jpg", "JPEG Image Images");
	 * 
	 ...
	 * @see #addExtension
	 */
	public SpokFileFilter(String extension, String description) {
		this();
		if (extension != null) {
	 ...
	 * SpokFileFilter(String {"gif", "jpg"});
	 * 
	 * Note that the "." before the extension is not needed adn will be ignored.
	 * 
	 * @see #addExtension
	 */
	public SpokFileFilter(String[] filters) {
		this(filters, null);
	}

	/**
	 * Creates a file filter from the given string array and description.
	 * Example: new SpokFileFilter(String {"gif", "jpg"}, "Gif and JPG Images");
	 * 
	 * Note that the "." before the extension is not needed and will be ignored.
	 * 
	 * @see #addExtension
	 */
	public SpokFileFilter(String[] filters, String description) {
		this();
	 ...
	 * 
	 * SpokFileFilter filter = new SpokFileFilter(); filter.addExtension("jpg");
	...
	public void addExtension(String extension) {
		if (filters == null) {
			filters = new Hashtable<String,SpokFileFilter>(5);
		}
